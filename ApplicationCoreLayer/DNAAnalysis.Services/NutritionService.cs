...
public class NutritionService : INutritionService
{
    ...
    public async Task<NutritionPlanDto?> GeneratePlanAsync(string userId)
    {
        ...
        {
            new MealSuggestion { NutritionPlanId = plan.Id, MealType = MealType.Breakfast, FoodName = "Scrambled Eggs", Calories = 302, Grams = 150 },
            new MealSuggestion { NutritionPlanId = plan.Id, MealType = MealType.Lunch, FoodName = "Chicken Soup", Calories = 320, Grams = 200 },
            new MealSuggestion { NutritionPlanId = plan.Id, MealType = MealType.Dinner, FoodName = "Soft Pasta", Calories = 400, Grams = 220 },
            new MealSuggestion { NutritionPlanId = plan.Id, MealType = MealType.Snack, FoodName = "Yogurt", Calories = 150, Grams = 120 }
        };
