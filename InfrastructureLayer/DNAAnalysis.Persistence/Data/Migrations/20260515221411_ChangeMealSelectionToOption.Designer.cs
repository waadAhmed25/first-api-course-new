...
namespace DNAAnalysis.Persistence.Data.Migrations
{
    ...
    [Migration("20260515221411_ChangeMealSelectionToOption")]
    partial class ChangeMealSelectionToOption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DNAAnalysis.Domain.Entities.NutritionModule.MealOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DNAAnalysis.Domain.Entities.NutritionModule.NutritionPlan", b =>
                {
                    ...
                    b.Property<double>("FinalCaloriesGoal")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("DNAAnalysis.Domain.Entities.NutritionModule.NutritionProfile", b =>
                {
                    ...
                    b.Property<bool>("IncludeNightSnack")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DNAAnalysis.Domain.Entities.UserMealSelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DNAAnalysis.Domain.Entities.UserMealSelection", b =>
                {
                    b.HasOne("DNAAnalysis.Domain.Entities.NutritionModule.MealOption", "MealOption")
                        .WithMany()
